...
<html>
	...
	<body>
		<a href="#edit-lectureTimeTable" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-lectureTimeTable" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${lectureTimeTableInstance?.version}" />
				<fieldset class="form">
