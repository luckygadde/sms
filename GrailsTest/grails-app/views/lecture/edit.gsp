...
<html>
	...
	<body>
		<a href="#edit-lecture" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<%--			</ul>--%>
<%--		</div>--}%--%>
		<div id="edit-lecture" class="content scaffold-edit" role="main">
