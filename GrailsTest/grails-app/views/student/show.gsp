			...
			<ol class="property-list student">
				...
				<li class="fieldcontain">
					<span id="stream-label" class="property-label"><g:message code="student.stream.label" default="Streams" /></span>
						...
						<span class="property-value" aria-labelledby="stream-label"><g:link controller="stream" action="show" id="${studentInstance?.stream?.id}">${studentInstance?.stream?.coursename.encodeAsHTML()}</g:link></span>
