...
<html>
	...
	<body>
		<a href="#create-stream" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-stream" class="content scaffold-create" role="main">
