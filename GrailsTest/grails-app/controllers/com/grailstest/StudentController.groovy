...
//		def emaild=studentInstance.email
//		def studentname=studentInstance.firstName
//		def domain=1
//		mailserviceService.sendSucessMail(emaild,studentname,domain)
